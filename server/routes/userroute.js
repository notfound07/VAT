...
const { signup, login, contact,getAllcontacts,order,booking,Allbooking,product,update_product,getAllProducts,getById,deleteById } = require("../controllers/usercontroller");
